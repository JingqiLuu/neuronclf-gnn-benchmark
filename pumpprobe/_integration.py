# This code is based on the integration module previously found in the mistofrutta library.
# It provides the Gregory integration formula required by the pumpprobe package.

import numpy as np

# Gregory integration formula coefficients
